...
TEST(HAL_TIMER, TimerInit){
    ...
    HAL_TIMER_SetCount(TIMER0, (uint64_t)PLL_INPUT_OSC_RATE / 1000); /* Ms count */
...
TEST(HAL_TIMER, TimerSetCount){
    ...
    HAL_TIMER_SetCount(TIMER1, (uint64_t)PLL_INPUT_OSC_RATE / 1000); /* Ms count */
