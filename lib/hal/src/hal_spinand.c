...
static const struct SPINAND_INFO s_spiNandTable[] = {
    /* TC58CVG0S0HxAIx */
    { 0x98C2, 4, 0x40, 1, 1024, 0x00, 18, 0x8, 0xFF, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* TC58CVG1S0HxAIx */
    { 0x98CB, 4, 0x40, 2, 1024, 0x00, 19, 0x8, 0xFF, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* MX35LF1GE4AB */
    { 0xC212, 4, 0x40, 1, 1024, 0x0C, 18, 0x4, 0xB0, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* MX35LF2GE4AB */
    { 0xC222, 4, 0x40, 2, 1024, 0x0C, 19, 0x4, 0xB0, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* GD5F1GQ4UAYIG */
    { 0xC8F1, 4, 0x40, 1, 1024, 0x0C, 18, 0x8, 0xB0, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* MT29F1G01ZAC */
    { 0x2C12, 4, 0x40, 1, 1024, 0x00, 18, 0x1, 0xB0, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* GD5F2GQ40BY2GR */
    { 0xC8D2, 4, 0x40, 2, 1024, 0x0C, 19, 0x8, 0xB0, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus3 },
    /* GD5F1GQ4RB9IGR */
    { 0xC8D1, 4, 0x40, 1, 1024, 0x0C, 18, 0x8, 0xB0, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus3 },
    /* IS37SML01G1 */
    { 0xC821, 4, 0x40, 1, 1024, 0x00, 18, 0x1, 0xFF, { 0x08, 0x0C, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* W25N01GV */
    { 0xEFAA, 4, 0x40, 1, 1024, 0x4C, 18, 0x1, 0xFF, { 0x04, 0x14, 0x24, 0xFF }, &SPINAND_GetEccStatus1 },
    /* HYF2GQ4UAACAE */
    { 0xC952, 4, 0x40, 1, 2048, 0x4C, 19, 0xE, 0xB0, { 0x04, 0x24, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* HYF2GQ4UDACAE */
    { 0xC922, 4, 0x40, 1, 2048, 0x4C, 19, 0x4, 0xB0, { 0x04, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* HYF2GQ4UHCCAE */
    { 0xC95A, 4, 0x40, 1, 2048, 0x4C, 19, 0xE, 0xB0, { 0x04, 0x24, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* HYF1GQ4UDACAE */
    { 0xC921, 4, 0x40, 1, 1024, 0x4C, 18, 0x4, 0xB0, { 0x04, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* F50L1G41LB */
    { 0xC801, 4, 0x40, 1, 1024, 0x4C, 18, 0x1, 0xFF, { 0x14, 0x24, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* XT26G02A */
    { 0x0BE2, 4, 0x40, 1, 2048, 0x4C, 19, 0x1, 0xB0, { 0x08, 0x0C, 0xFF, 0xFF }, &SPINAND_GetEccStatus4 },
    /* XT26G01A */
    { 0x0BE1, 4, 0x40, 1, 1024, 0x4C, 18, 0x1, 0xB0, { 0x08, 0x0C, 0xFF, 0xFF }, &SPINAND_GetEccStatus4 },
    /* FS35ND01G-S1 */
    { 0xCDB1, 4, 0x40, 1, 1024, 0x0C, 18, 0x4, 0xB0, { 0x10, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus5 },
    /* FS35ND02G-S2 */
    { 0xCDA2, 4, 0x40, 1, 2048, 0x00, 19, 0x4, 0xFF, { 0x10, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus5 },
    /* DS35Q1GA-1B */
    { 0xE571, 4, 0x40, 1, 1024, 0x0C, 18, 0x4, 0xB0, { 0x04, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* DS35Q2GA-1B */
    { 0xE572, 4, 0x40, 2, 1024, 0x0C, 19, 0x4, 0xB0, { 0x04, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* EM73C044SNC-G */
    { 0xD522, 4, 0x40, 1, 1024, 0x0C, 18, 0x8, 0xB0, { 0x04, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* EM73D044SNB-G */
    { 0xD520, 4, 0x40, 1, 2048, 0x0C, 19, 0x8, 0xB0, { 0x04, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* ATO25D1GA */
    { 0x9B12, 4, 0x40, 1, 1024, 0x40, 18, 0x1, 0xB0, { 0x14, 0x24, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* XT26G02B */
    { 0x0BF2, 4, 0x40, 1, 2048, 0x4C, 19, 0x1, 0xB0, { 0x08, 0x0C, 0xFF, 0xFF }, &SPINAND_GetEccStatus5 },
    /* XT26G01B */
    { 0x0BF1, 4, 0x40, 1, 1024, 0x4C, 18, 0x1, 0xB0, { 0x08, 0x0C, 0xFF, 0xFF }, &SPINAND_GetEccStatus4 },
    /* HYF4GQ4UAACBE */
    { 0xC9D4, 8, 0x40, 1, 2048, 0x4C, 20, 0x4, 0xB0, { 0x20, 0x40, 0x24, 0x44 }, &SPINAND_GetEccStatus0 },
    /* FM25S01 */
    { 0xA1A1, 4, 0x40, 1, 1024, 0x4C, 18, 0x1, 0xB0, { 0x00, 0x04, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* HYF1GQ4UPACAE */
    { 0xC9A1, 4, 0x40, 1, 1024, 0x4C, 18, 0x4, 0xB0, { 0x04, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* EM73E044SNA-G */
    { 0xD503, 8, 0x40, 1, 2048, 0x4C, 20, 0x8, 0xB0, { 0x04, 0x28, 0x08, 0x2C }, &SPINAND_GetEccStatus0 },
    /* GD5F2GQ5UEYIG */
    { 0xC852, 4, 0x40, 1, 2048, 0x4C, 19, 0x4, 0xB0, { 0x04, 0x14, 0xFF, 0xFF }, &SPINAND_GetEccStatus2 },
    /* GD5F1GQ4R */
    { 0xC8C1, 4, 0x40, 1, 1024, 0x0C, 18, 0x8, 0xB0, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus3 },
    /* TC58CVG2S0HRAIJ */
    { 0x98ED, 8, 0x40, 1, 2048, 0x0C, 20, 0x8, 0xFF, { 0x04, 0x0C, 0x08, 0x10 }, &SPINAND_GetEccStatus0 },
    /* TC58CVG1S3HRAIJ */
    { 0x98EB, 4, 0x40, 1, 2048, 0x0C, 19, 0x8, 0xFF, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* TC58CVG0S3HRAIJ */
    { 0x98E2, 4, 0x40, 1, 1024, 0x0C, 18, 0x8, 0xFF, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus0 },
    /* XT26G04A */
    { 0x0BE3, 4, 0x80, 1, 2048, 0x4C, 20, 0x1, 0xB0, { 0x08, 0x0C, 0xFF, 0xFF }, &SPINAND_GetEccStatus4 },
    /* FS35ND01G-S1Y2 */
    { 0xCDEA, 4, 0x40, 1, 1024, 0x4C, 18, 0x4, 0xFF, { 0x04, 0x08, 0xFF, 0xFF }, &SPINAND_GetEccStatus1 },
    /* DS35M1GA-1B */
...
HAL_Status HAL_SPINAND_Init(struct SPI_NAND *spinand)
{
    ...
    if (spinand->spi->mode & HAL_SPI_TX_QUAD &&
        ...
        if (SPINAND_QuadEnable(spinand) == HAL_OK) {
            spinand->readLines = 4;
        }
    }
