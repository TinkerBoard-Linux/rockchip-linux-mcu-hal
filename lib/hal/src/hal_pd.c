...
#define GENVAL_ULL(x, h, l) ((uint64_t)(((x) & GENMASK_ULL(h, l)) >> (l)))
 ...
 *    [63:46]: reserved
 */
#define PD_GET_PWR_VALID(x)      GENVAL_ULL(x, 0, 0)
#define PD_GET_PWR_OFFSET(x)     GENVAL_ULL(x, 2, 1)
#define PD_GET_PWR_MASK(x)       GENVAL_ULL(x, 3, 3)
#define PD_GET_PWR_SHIFT(x)      GENVAL_ULL(x, 8, 4)
#define PD_GET_ST_OFFSET(x)      GENVAL_ULL(x, 10, 9)
#define PD_GET_ST_SHIFT(x)       GENVAL_ULL(x, 15, 11)
#define PD_GET_REQ_VALID(x)      GENVAL_ULL(x, 16, 16)
#define PD_GET_REQ_OFFSET(x)     GENVAL_ULL(x, 18, 17)
#define PD_GET_REQ_MASK(x)       GENVAL_ULL(x, 19, 19)
#define PD_GET_REQ_SHIFT(x)      GENVAL_ULL(x, 24, 20)
#define PD_GET_IDLE_OFFSET(x)    GENVAL_ULL(x, 26, 25)
#define PD_GET_IDLE_SHIFT(x)     GENVAL_ULL(x, 31, 27)
#define PD_GET_ACK_OFFSET(x)     GENVAL_ULL(x, 33, 32)
#define PD_GET_ACK_SHIFT(x)      GENVAL_ULL(x, 38, 34)
#define PD_GET_IDLE_ACK_REG(x)   GENVAL_ULL(x, 40, 39)
#define PD_GET_MEM_PWR_VALID(x)  GENVAL_ULL(x, 41, 41)
#define PD_GET_MEM_PWR_OFFSET(x) GENVAL_ULL(x, 43, 42)
#define PD_GET_MEM_PWR_SHIFT(x)  GENVAL_ULL(x, 48, 44)

#define PD_GET_MEM_ST_VALID(x)     GENVAL_ULL(x, 0, 0)
#define PD_GET_MEM_ST_OFFSET(x)    GENVAL_ULL(x, 2, 1)
#define PD_GET_MEM_ST_SHIFT(x)     GENVAL_ULL(x, 7, 3)
#define PD_GET_CHAIN_ST_VALID(x)   GENVAL_ULL(x, 8, 8)
#define PD_GET_CHAIN_ST_OFFSET(x)  GENVAL_ULL(x, 10, 9)
#define PD_GET_CHAIN_ST_SHIFT(x)   GENVAL_ULL(x, 15, 11)
#define PD_GET_REPAIR_VALID(x)     GENVAL_ULL(x, 16, 16)
#define PD_GET_REPAIR_ST_OFFSET(x) GENVAL_ULL(x, 18, 17)
#define PD_GET_REPAIR_ST_SHIFT(x)  GENVAL_ULL(x, 23, 19)
#define PD_GET_REQ1_VALID(x)       GENVAL_ULL(x, 24, 24)
#define PD_GET_REQ1_OFFSET(x)      GENVAL_ULL(x, 26, 25)
#define PD_GET_REQ1_SHIFT(x)       GENVAL_ULL(x, 31, 27)
#define PD_GET_IDLE1_OFFSET(x)     GENVAL_ULL(x, 33, 32)
#define PD_GET_IDLE1_SHIFT(x)      GENVAL_ULL(x, 38, 34)
#define PD_GET_ACK1_OFFSET(x)      GENVAL_ULL(x, 40, 39)
#define PD_GET_ACK1_SHIFT(x)       GENVAL_ULL(x, 45, 41)

#define PD_IS_INVALID(x)  (!GENVAL(x, 31, 31))
#define PD_GET_VALIDID(x) GENVAL(x, 30, 0)
