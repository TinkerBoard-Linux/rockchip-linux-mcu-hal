...
#define __CM3_REV                 0x0200U  /* Core revision r2p1                            */
#define __VTOR_PRESENT            1U       /* VTOR present */
#define __NVIC_PRIO_BITS          3U       /* RK2108 uses 4 Bits for the Priority Levels */
...
struct GRF_REG {
    ...
    __IO uint32_t DSP_STATUS[2];                      /* Address Offset: 0x0190 */
    ...
    __IO uint32_t OS_REG[4];                          /* Address Offset: 0x0200 */
         uint32_t RESERVED0210[28];                   /* Address Offset: 0x0210 */
    __IO uint32_t BBGEN_CON[4];                       /* Address Offset: 0x0280 */
    __I  uint32_t BBGEN_STATUS;                       /* Address Offset: 0x0290 */
         uint32_t RESERVED0294[11];                   /* Address Offset: 0x0294 */
    __IO uint32_t DLL_CON[2];                         /* Address Offset: 0x02C0 */
    __IO uint32_t DLL_STATUS[2];                      /* Address Offset: 0x02C8 */
...
struct TIMER_CHANNEL {
    __IO uint32_t TIMER_LOAD_COUNT[2];
    __IO uint32_t TIMER_CURR_VALUE[2];
    __IO uint32_t TIMER_CONTROL;
         uint32_t RESERVED0;
    __O  uint32_t TIMER_INTSTATUS;
         uint32_t RESERVED1;
};
struct TIMER_REG {
    struct TIMER_CHANNEL CHANNELS[TIMER_CHAN_CNT];    /* Address Offset: 0x0000 */
         uint32_t RESERVED00C0[12];                   /* Address Offset: 0x00C0 */
...
/* RKI2C Register Structure Define */
struct RKI2C_REG {
...
struct PMU_REG {
    ...
    __IO uint32_t SYS_REG[2];                         /* Address Offset: 0x0080 */
         uint32_t RESERVED0088;                       /* Address Offset: 0x0088 */
    __IO uint32_t SYS_REG1[2];                        /* Address Offset: 0x008C */
};
...
struct CRU_REG {
    ...
    __IO uint32_t MODE_CON;                           /* Address Offset: 0x000C */
         uint32_t RESERVED0010[20];                   /* Address Offset: 0x0010 */
    ...
    __I  uint32_t GPLL_STAT0;                         /* Address Offset: 0x0094 */
         uint32_t RESERVED0098[26];                   /* Address Offset: 0x0098 */
    __IO uint32_t CLKSEL0_CON;                        /* Address Offset: 0x0100 */
    __IO uint32_t CLKSEL1_CON;                        /* Address Offset: 0x0104 */
    __IO uint32_t CLKSEL2_CON;                        /* Address Offset: 0x0108 */
    __IO uint32_t CLKSEL3_CON;                        /* Address Offset: 0x010C */
    __IO uint32_t CLKSEL4_CON;                        /* Address Offset: 0x0110 */
    __IO uint32_t CLKSEL5_CON;                        /* Address Offset: 0x0114 */
    __IO uint32_t CLKSEL6_CON;                        /* Address Offset: 0x0118 */
    __IO uint32_t CLKSEL7_CON;                        /* Address Offset: 0x011C */
    __IO uint32_t CLKSEL8_CON;                        /* Address Offset: 0x0120 */
    __IO uint32_t CLKSEL9_CON;                        /* Address Offset: 0x0124 */
    __IO uint32_t CLKSEL10_CON;                       /* Address Offset: 0x0128 */
    __IO uint32_t CLKSEL11_CON;                       /* Address Offset: 0x012C */
    __IO uint32_t CLKSEL12_CON;                       /* Address Offset: 0x0130 */
    __IO uint32_t CLKSEL13_CON;                       /* Address Offset: 0x0134 */
    __IO uint32_t CLKSEL14_CON;                       /* Address Offset: 0x0138 */
    __IO uint32_t CLKSEL15_CON;                       /* Address Offset: 0x013C */
    __IO uint32_t CLKSEL16_CON;                       /* Address Offset: 0x0140 */
    __IO uint32_t CLKSEL17_CON;                       /* Address Offset: 0x0144 */
         uint32_t RESERVED0148[46];                   /* Address Offset: 0x0148 */
    __IO uint32_t CLKGATE0_CON;                       /* Address Offset: 0x0200 */
    __IO uint32_t CLKGATE1_CON;                       /* Address Offset: 0x0204 */
    __IO uint32_t CLKGATE2_CON;                       /* Address Offset: 0x0208 */
    __IO uint32_t CLKGATE3_CON;                       /* Address Offset: 0x020C */
    __IO uint32_t CLKGATE4_CON;                       /* Address Offset: 0x0210 */
    __IO uint32_t CLKGATE5_CON;                       /* Address Offset: 0x0214 */
         uint32_t RESERVED0218[58];                   /* Address Offset: 0x0218 */
    __IO uint32_t SOFTRST0_CON;                       /* Address Offset: 0x0300 */
    __IO uint32_t SOFTRST1_CON;                       /* Address Offset: 0x0304 */
    __IO uint32_t SOFTRST2_CON;                       /* Address Offset: 0x0308 */
    __IO uint32_t SOFTRST3_CON;                       /* Address Offset: 0x030C */
    __IO uint32_t SOFTRST4_CON;                       /* Address Offset: 0x0310 */
    __IO uint32_t SOFTRST5_CON;                       /* Address Offset: 0x0314 */
         uint32_t RESERVED0318[58];                   /* Address Offset: 0x0318 */
...
#define SFC_BASE            0x44100000U /* SFC base address */
...
#define TIMER               ((struct TIMER_REG *) TIMER_BASE)
...
#define GRF_SOC_CON0_RF_XO_EN_SHIFT                        (10U)
#define GRF_SOC_CON0_RF_XO_EN_MASK                         (0x1U << GRF_SOC_CON0_RF_XO_EN_SHIFT)                        /* 0x00000400 */
#define GRF_SOC_CON0_RF_XO_EN_SEL_SHIFT                    (11U)
#define GRF_SOC_CON0_RF_XO_EN_SEL_MASK                     (0x1U << GRF_SOC_CON0_RF_XO_EN_SEL_SHIFT)                    /* 0x00000800 */
...
#define GRF_SOC_CON2_REV_SHIFT                             (2U)
#define GRF_SOC_CON2_REV_MASK                              (0x3U << GRF_SOC_CON2_REV_SHIFT)                             /* 0x0000000C */
...
#define GRF_GPIOMUX_PLUS_GPIO1C7_SEL2_SHIFT                (4U)
#define GRF_GPIOMUX_PLUS_GPIO1C7_SEL2_MASK                 (0x1U << GRF_GPIOMUX_PLUS_GPIO1C7_SEL2_SHIFT)                /* 0x00000010 */
...
#define GRF_GPIO2C_IOMUX_GPIO1C4_SEL_SHIFT                 (8U)
#define GRF_GPIO2C_IOMUX_GPIO1C4_SEL_MASK                  (0x3U << GRF_GPIO2C_IOMUX_GPIO1C4_SEL_SHIFT)                 /* 0x00000300 */
#define GRF_GPIO2C_IOMUX_GPIO1C5_SEL_SHIFT                 (10U)
#define GRF_GPIO2C_IOMUX_GPIO1C5_SEL_MASK                  (0x3U << GRF_GPIO2C_IOMUX_GPIO1C5_SEL_SHIFT)                 /* 0x00000C00 */
#define GRF_GPIO2C_IOMUX_GPIO1C6_SEL_SHIFT                 (12U)
#define GRF_GPIO2C_IOMUX_GPIO1C6_SEL_MASK                  (0x3U << GRF_GPIO2C_IOMUX_GPIO1C6_SEL_SHIFT)                 /* 0x00003000 */
#define GRF_GPIO2C_IOMUX_GPIO1C7_SEL_SHIFT                 (14U)
#define GRF_GPIO2C_IOMUX_GPIO1C7_SEL_MASK                  (0x3U << GRF_GPIO2C_IOMUX_GPIO1C7_SEL_SHIFT)                 /* 0x0000C000 */
/* GPIO2D_IOMUX */
...
/* GPIO1A_S */
#define GRF_GPIO1A_S_GPIO0A_SLW_SHIFT                      (0U)
#define GRF_GPIO1A_S_GPIO0A_SLW_MASK                       (0x1FU << GRF_GPIO1A_S_GPIO0A_SLW_SHIFT)                     /* 0x0000001F */
#define GRF_GPIO1A_S_GPIO0A_SMT_SHIFT                      (5U)
#define GRF_GPIO1A_S_GPIO0A_SMT_MASK                       (0x1FU << GRF_GPIO1A_S_GPIO0A_SMT_SHIFT)                     /* 0x000003E0 */
/* GPIO1B_S */
...
/* GPIO2C_S */
#define GRF_GPIO2C_S_GPIO2C_SLW_SHIFT                      (0U)
#define GRF_GPIO2C_S_GPIO2C_SLW_MASK                       (0xFFU << GRF_GPIO2C_S_GPIO2C_SLW_SHIFT)                     /* 0x000000FF */
#define GRF_GPIO2C_S_GPIO2C_SMT_SHIFT                      (8U)
#define GRF_GPIO2C_S_GPIO2C_SMT_MASK                       (0xFFU << GRF_GPIO2C_S_GPIO2C_SMT_SHIFT)                     /* 0x0000FF00 */
/* GPIO2D_S */
#define GRF_GPIO2D_S_GPIO2D_SLW_SHIFT                      (0U)
#define GRF_GPIO2D_S_GPIO2D_SLW_MASK                       (0xFFU << GRF_GPIO2D_S_GPIO2D_SLW_SHIFT)                     /* 0x000000FF */
#define GRF_GPIO2D_S_GPIO2D_SMT_SHIFT                      (8U)
#define GRF_GPIO2D_S_GPIO2D_SMT_MASK                       (0xFFU << GRF_GPIO2D_S_GPIO2D_SMT_SHIFT)                     /* 0x0000FF00 */
/* MCU_STCALIB */
...
#define WDT_WDT_CR_RST_PLUSE_LENGTH_SHIFT                  (2U)
#define WDT_WDT_CR_RST_PLUSE_LENGTH_MASK                   (0x3U << WDT_WDT_CR_RST_PLUSE_LENGTH_SHIFT)                  /* 0x0000000C */
/* WDT_TORR */
...
/*****************************************RKI2C******************************************/
/* CON */
#define RKI2C_CON_I2C_EN_SHIFT                             (0U)
#define RKI2C_CON_I2C_EN_MASK                              (0x1U << RKI2C_CON_I2C_EN_SHIFT)                             /* 0x00000001 */
#define RKI2C_CON_I2C_MODE_SHIFT                           (1U)
#define RKI2C_CON_I2C_MODE_MASK                            (0x3U << RKI2C_CON_I2C_MODE_SHIFT)                           /* 0x00000006 */
#define RKI2C_CON_START_SHIFT                              (3U)
#define RKI2C_CON_START_MASK                               (0x1U << RKI2C_CON_START_SHIFT)                              /* 0x00000008 */
#define RKI2C_CON_STOP_SHIFT                               (4U)
#define RKI2C_CON_STOP_MASK                                (0x1U << RKI2C_CON_STOP_SHIFT)                               /* 0x00000010 */
#define RKI2C_CON_ACK_SHIFT                                (5U)
#define RKI2C_CON_ACK_MASK                                 (0x1U << RKI2C_CON_ACK_SHIFT)                                /* 0x00000020 */
#define RKI2C_CON_ACT2NAK_SHIFT                            (6U)
#define RKI2C_CON_ACT2NAK_MASK                             (0x1U << RKI2C_CON_ACT2NAK_SHIFT)                            /* 0x00000040 */
#define RKI2C_CON_DATA_UPD_ST_SHIFT                        (8U)
#define RKI2C_CON_DATA_UPD_ST_MASK                         (0x7U << RKI2C_CON_DATA_UPD_ST_SHIFT)                        /* 0x00000700 */
#define RKI2C_CON_START_SETUP_SHIFT                        (12U)
#define RKI2C_CON_START_SETUP_MASK                         (0x3U << RKI2C_CON_START_SETUP_SHIFT)                        /* 0x00003000 */
#define RKI2C_CON_STOP_SETUP_SHIFT                         (14U)
#define RKI2C_CON_STOP_SETUP_MASK                          (0x3U << RKI2C_CON_STOP_SETUP_SHIFT)                         /* 0x0000C000 */
#define RKI2C_CON_VERSION_SHIFT                            (16U)
#define RKI2C_CON_VERSION_MASK                             (0xFFFFU << RKI2C_CON_VERSION_SHIFT)                         /* 0xFFFF0000 */
/* CLKDIV */
#define RKI2C_CLKDIV_CLKDIVL_SHIFT                         (0U)
#define RKI2C_CLKDIV_CLKDIVL_MASK                          (0xFFFFU << RKI2C_CLKDIV_CLKDIVL_SHIFT)                      /* 0x0000FFFF */
#define RKI2C_CLKDIV_CLKDIVH_SHIFT                         (16U)
#define RKI2C_CLKDIV_CLKDIVH_MASK                          (0xFFFFU << RKI2C_CLKDIV_CLKDIVH_SHIFT)                      /* 0xFFFF0000 */
/* MRXADDR */
#define RKI2C_MRXADDR_SADDR_SHIFT                          (0U)
#define RKI2C_MRXADDR_SADDR_MASK                           (0xFFFFFFU << RKI2C_MRXADDR_SADDR_SHIFT)                     /* 0x00FFFFFF */
#define RKI2C_MRXADDR_ADDLVLD_SHIFT                        (24U)
#define RKI2C_MRXADDR_ADDLVLD_MASK                         (0x1U << RKI2C_MRXADDR_ADDLVLD_SHIFT)                        /* 0x01000000 */
#define RKI2C_MRXADDR_ADDMVLD_SHIFT                        (25U)
#define RKI2C_MRXADDR_ADDMVLD_MASK                         (0x1U << RKI2C_MRXADDR_ADDMVLD_SHIFT)                        /* 0x02000000 */
#define RKI2C_MRXADDR_ADDHVLD_SHIFT                        (26U)
#define RKI2C_MRXADDR_ADDHVLD_MASK                         (0x1U << RKI2C_MRXADDR_ADDHVLD_SHIFT)                        /* 0x04000000 */
/* MRXRADDR */
#define RKI2C_MRXRADDR_SRADDR_SHIFT                        (0U)
#define RKI2C_MRXRADDR_SRADDR_MASK                         (0xFFFFFFU << RKI2C_MRXRADDR_SRADDR_SHIFT)                   /* 0x00FFFFFF */
#define RKI2C_MRXRADDR_SRADDLVLD_SHIFT                     (24U)
#define RKI2C_MRXRADDR_SRADDLVLD_MASK                      (0x1U << RKI2C_MRXRADDR_SRADDLVLD_SHIFT)                     /* 0x01000000 */
#define RKI2C_MRXRADDR_SRADDMVLD_SHIFT                     (25U)
#define RKI2C_MRXRADDR_SRADDMVLD_MASK                      (0x1U << RKI2C_MRXRADDR_SRADDMVLD_SHIFT)                     /* 0x02000000 */
#define RKI2C_MRXRADDR_SRADDHVLD_SHIFT                     (26U)
#define RKI2C_MRXRADDR_SRADDHVLD_MASK                      (0x1U << RKI2C_MRXRADDR_SRADDHVLD_SHIFT)                     /* 0x04000000 */
/* MTXCNT */
#define RKI2C_MTXCNT_MTXCNT_SHIFT                          (0U)
#define RKI2C_MTXCNT_MTXCNT_MASK                           (0x3FU << RKI2C_MTXCNT_MTXCNT_SHIFT)                         /* 0x0000003F */
/* MRXCNT */
#define RKI2C_MRXCNT_MRXCNT_SHIFT                          (0U)
#define RKI2C_MRXCNT_MRXCNT_MASK                           (0x3FU << RKI2C_MRXCNT_MRXCNT_SHIFT)                         /* 0x0000003F */
/* IEN */
#define RKI2C_IEN_BTFIEN_SHIFT                             (0U)
#define RKI2C_IEN_BTFIEN_MASK                              (0x1U << RKI2C_IEN_BTFIEN_SHIFT)                             /* 0x00000001 */
#define RKI2C_IEN_BRFIEN_SHIFT                             (1U)
#define RKI2C_IEN_BRFIEN_MASK                              (0x1U << RKI2C_IEN_BRFIEN_SHIFT)                             /* 0x00000002 */
#define RKI2C_IEN_MBTFIEN_SHIFT                            (2U)
#define RKI2C_IEN_MBTFIEN_MASK                             (0x1U << RKI2C_IEN_MBTFIEN_SHIFT)                            /* 0x00000004 */
#define RKI2C_IEN_MBRFIEN_SHIFT                            (3U)
#define RKI2C_IEN_MBRFIEN_MASK                             (0x1U << RKI2C_IEN_MBRFIEN_SHIFT)                            /* 0x00000008 */
#define RKI2C_IEN_STARTIEN_SHIFT                           (4U)
#define RKI2C_IEN_STARTIEN_MASK                            (0x1U << RKI2C_IEN_STARTIEN_SHIFT)                           /* 0x00000010 */
#define RKI2C_IEN_STOPIEN_SHIFT                            (5U)
#define RKI2C_IEN_STOPIEN_MASK                             (0x1U << RKI2C_IEN_STOPIEN_SHIFT)                            /* 0x00000020 */
#define RKI2C_IEN_NAKRCVIEN_SHIFT                          (6U)
#define RKI2C_IEN_NAKRCVIEN_MASK                           (0x1U << RKI2C_IEN_NAKRCVIEN_SHIFT)                          /* 0x00000040 */
#define RKI2C_IEN_SLAVEHDSCLEN_SHIFT                       (7U)
#define RKI2C_IEN_SLAVEHDSCLEN_MASK                        (0x1U << RKI2C_IEN_SLAVEHDSCLEN_SHIFT)                       /* 0x00000080 */
/* IPD */
#define RKI2C_IPD_BTFIPD_SHIFT                             (0U)
#define RKI2C_IPD_BTFIPD_MASK                              (0x1U << RKI2C_IPD_BTFIPD_SHIFT)                             /* 0x00000001 */
#define RKI2C_IPD_BRFIPD_SHIFT                             (1U)
#define RKI2C_IPD_BRFIPD_MASK                              (0x1U << RKI2C_IPD_BRFIPD_SHIFT)                             /* 0x00000002 */
#define RKI2C_IPD_MBTFIPD_SHIFT                            (2U)
#define RKI2C_IPD_MBTFIPD_MASK                             (0x1U << RKI2C_IPD_MBTFIPD_SHIFT)                            /* 0x00000004 */
#define RKI2C_IPD_MBRFIPD_SHIFT                            (3U)
#define RKI2C_IPD_MBRFIPD_MASK                             (0x1U << RKI2C_IPD_MBRFIPD_SHIFT)                            /* 0x00000008 */
#define RKI2C_IPD_STARTIPD_SHIFT                           (4U)
#define RKI2C_IPD_STARTIPD_MASK                            (0x1U << RKI2C_IPD_STARTIPD_SHIFT)                           /* 0x00000010 */
#define RKI2C_IPD_STOPIPD_SHIFT                            (5U)
#define RKI2C_IPD_STOPIPD_MASK                             (0x1U << RKI2C_IPD_STOPIPD_SHIFT)                            /* 0x00000020 */
#define RKI2C_IPD_NAKRCVIPD_SHIFT                          (6U)
#define RKI2C_IPD_NAKRCVIPD_MASK                           (0x1U << RKI2C_IPD_NAKRCVIPD_SHIFT)                          /* 0x00000040 */
#define RKI2C_IPD_SLAVEHDSCLIPD_SHIFT                      (7U)
#define RKI2C_IPD_SLAVEHDSCLIPD_MASK                       (0x1U << RKI2C_IPD_SLAVEHDSCLIPD_SHIFT)                      /* 0x00000080 */
/* FCNT */
#define RKI2C_FCNT_FCNT_SHIFT                              (0U)
#define RKI2C_FCNT_FCNT_MASK                               (0x3FU << RKI2C_FCNT_FCNT_SHIFT)                             /* 0x0000003F */
/* SCL_OE_DB */
#define RKI2C_SCL_OE_DB_SCL_OE_DB_SHIFT                    (0U)
#define RKI2C_SCL_OE_DB_SCL_OE_DB_MASK                     (0xFFU << RKI2C_SCL_OE_DB_SCL_OE_DB_SHIFT)                   /* 0x000000FF */
/* TXDATA0 */
#define RKI2C_TXDATA0_TXDATA0_SHIFT                        (0U)
#define RKI2C_TXDATA0_TXDATA0_MASK                         (0xFFFFFFFFU << RKI2C_TXDATA0_TXDATA0_SHIFT)                 /* 0xFFFFFFFF */
/* TXDATA1 */
#define RKI2C_TXDATA1_TXDATA1_SHIFT                        (0U)
#define RKI2C_TXDATA1_TXDATA1_MASK                         (0xFFFFFFFFU << RKI2C_TXDATA1_TXDATA1_SHIFT)                 /* 0xFFFFFFFF */
/* TXDATA2 */
#define RKI2C_TXDATA2_TXDATA2_SHIFT                        (0U)
#define RKI2C_TXDATA2_TXDATA2_MASK                         (0xFFFFFFFFU << RKI2C_TXDATA2_TXDATA2_SHIFT)                 /* 0xFFFFFFFF */
/* TXDATA3 */
#define RKI2C_TXDATA3_TXDATA3_SHIFT                        (0U)
#define RKI2C_TXDATA3_TXDATA3_MASK                         (0xFFFFFFFFU << RKI2C_TXDATA3_TXDATA3_SHIFT)                 /* 0xFFFFFFFF */
/* TXDATA4 */
#define RKI2C_TXDATA4_TXDATA4_SHIFT                        (0U)
#define RKI2C_TXDATA4_TXDATA4_MASK                         (0xFFFFFFFFU << RKI2C_TXDATA4_TXDATA4_SHIFT)                 /* 0xFFFFFFFF */
/* TXDATA5 */
#define RKI2C_TXDATA5_TXDATA5_SHIFT                        (0U)
#define RKI2C_TXDATA5_TXDATA5_MASK                         (0xFFFFFFFFU << RKI2C_TXDATA5_TXDATA5_SHIFT)                 /* 0xFFFFFFFF */
/* TXDATA6 */
#define RKI2C_TXDATA6_TXDATA6_SHIFT                        (0U)
#define RKI2C_TXDATA6_TXDATA6_MASK                         (0xFFFFFFFFU << RKI2C_TXDATA6_TXDATA6_SHIFT)                 /* 0xFFFFFFFF */
/* TXDATA7 */
#define RKI2C_TXDATA7_TXDATA7_SHIFT                        (0U)
#define RKI2C_TXDATA7_TXDATA7_MASK                         (0xFFFFFFFFU << RKI2C_TXDATA7_TXDATA7_SHIFT)                 /* 0xFFFFFFFF */
/* RXDATA0 */
#define RKI2C_RXDATA0_RXDATA0_SHIFT                        (0U)
#define RKI2C_RXDATA0_RXDATA0_MASK                         (0xFFFFFFFFU << RKI2C_RXDATA0_RXDATA0_SHIFT)                 /* 0xFFFFFFFF */
/* RXDATA1 */
#define RKI2C_RXDATA1_RXDATA1_SHIFT                        (0U)
#define RKI2C_RXDATA1_RXDATA1_MASK                         (0xFFFFFFFFU << RKI2C_RXDATA1_RXDATA1_SHIFT)                 /* 0xFFFFFFFF */
/* RXDATA2 */
#define RKI2C_RXDATA2_RXDATA2_SHIFT                        (0U)
#define RKI2C_RXDATA2_RXDATA2_MASK                         (0xFFFFFFFFU << RKI2C_RXDATA2_RXDATA2_SHIFT)                 /* 0xFFFFFFFF */
/* RXDATA3 */
#define RKI2C_RXDATA3_RXDATA3_SHIFT                        (0U)
#define RKI2C_RXDATA3_RXDATA3_MASK                         (0xFFFFFFFFU << RKI2C_RXDATA3_RXDATA3_SHIFT)                 /* 0xFFFFFFFF */
/* RXDATA4 */
#define RKI2C_RXDATA4_RXDATA4_SHIFT                        (0U)
#define RKI2C_RXDATA4_RXDATA4_MASK                         (0xFFFFFFFFU << RKI2C_RXDATA4_RXDATA4_SHIFT)                 /* 0xFFFFFFFF */
/* RXDATA5 */
#define RKI2C_RXDATA5_RXDATA5_SHIFT                        (0U)
#define RKI2C_RXDATA5_RXDATA5_MASK                         (0xFFFFFFFFU << RKI2C_RXDATA5_RXDATA5_SHIFT)                 /* 0xFFFFFFFF */
/* RXDATA6 */
#define RKI2C_RXDATA6_RXDATA6_SHIFT                        (0U)
#define RKI2C_RXDATA6_RXDATA6_MASK                         (0xFFFFFFFFU << RKI2C_RXDATA6_RXDATA6_SHIFT)                 /* 0xFFFFFFFF */
/* RXDATA7 */
#define RKI2C_RXDATA7_RXDATA7_SHIFT                        (0U)
#define RKI2C_RXDATA7_RXDATA7_MASK                         (0xFFFFFFFFU << RKI2C_RXDATA7_RXDATA7_SHIFT)                 /* 0xFFFFFFFF */
/* ST */
#define RKI2C_ST_SDA_ST_SHIFT                              (0U)
#define RKI2C_ST_SDA_ST_MASK                               (0x1U << RKI2C_ST_SDA_ST_SHIFT)                              /* 0x00000001 */
#define RKI2C_ST_SCL_ST_SHIFT                              (1U)
#define RKI2C_ST_SCL_ST_MASK                               (0x1U << RKI2C_ST_SCL_ST_SHIFT)                              /* 0x00000002 */
/* DBGCTRL */
#define RKI2C_DBGCTRL_FLT_F_SHIFT                          (0U)
#define RKI2C_DBGCTRL_FLT_F_MASK                           (0xFU << RKI2C_DBGCTRL_FLT_F_SHIFT)                          /* 0x0000000F */
#define RKI2C_DBGCTRL_FLT_R_SHIFT                          (4U)
#define RKI2C_DBGCTRL_FLT_R_MASK                           (0xFU << RKI2C_DBGCTRL_FLT_R_SHIFT)                          /* 0x000000F0 */
#define RKI2C_DBGCTRL_SLV_HOLD_SCL_TH_SHIFT                (8U)
#define RKI2C_DBGCTRL_SLV_HOLD_SCL_TH_MASK                 (0xFU << RKI2C_DBGCTRL_SLV_HOLD_SCL_TH_SHIFT)                /* 0x00000F00 */
#define RKI2C_DBGCTRL_FLT_EN_SHIFT                         (12U)
#define RKI2C_DBGCTRL_FLT_EN_MASK                          (0x1U << RKI2C_DBGCTRL_FLT_EN_SHIFT)                         /* 0x00001000 */
#define RKI2C_DBGCTRL_NAK_RELEASE_SCL_SHIFT                (13U)
#define RKI2C_DBGCTRL_NAK_RELEASE_SCL_MASK                 (0x1U << RKI2C_DBGCTRL_NAK_RELEASE_SCL_SHIFT)                /* 0x00002000 */
#define RKI2C_DBGCTRL_H0_CHECK_SCL_SHIFT                   (14U)
#define RKI2C_DBGCTRL_H0_CHECK_SCL_MASK                    (0x1U << RKI2C_DBGCTRL_H0_CHECK_SCL_SHIFT)                   /* 0x00004000 */
/*****************************************EFUSE******************************************/
/* MOD */
...
/******************************************SFC*******************************************/
/* CTRL0 */
#define SFC_CTRL0_SPIM_SHIFT                               (0U)
#define SFC_CTRL0_SPIM_MASK                                (0x1U << SFC_CTRL0_SPIM_SHIFT)                               /* 0x00000001 */
#define SFC_CTRL0_SHIFTPHASE_SHIFT                         (1U)
#define SFC_CTRL0_SHIFTPHASE_MASK                          (0x1U << SFC_CTRL0_SHIFTPHASE_SHIFT)                         /* 0x00000002 */
#define SFC_CTRL0_IDLE_CYCLE_SHIFT                         (4U)
#define SFC_CTRL0_IDLE_CYCLE_MASK                          (0xFU << SFC_CTRL0_IDLE_CYCLE_SHIFT)                         /* 0x000000F0 */
#define SFC_CTRL0_CMDB_SHIFT                               (8U)
#define SFC_CTRL0_CMDB_MASK                                (0x3U << SFC_CTRL0_CMDB_SHIFT)                               /* 0x00000300 */
#define SFC_CTRL0_ADRB_SHIFT                               (10U)
#define SFC_CTRL0_ADRB_MASK                                (0x3U << SFC_CTRL0_ADRB_SHIFT)                               /* 0x00000C00 */
#define SFC_CTRL0_DATB_SHIFT                               (12U)
#define SFC_CTRL0_DATB_MASK                                (0x3U << SFC_CTRL0_DATB_SHIFT)                               /* 0x00003000 */
/* IMR */
...
/* AX0 */
#define SFC_AX0_AX_SHIFT                                   (0U)
#define SFC_AX0_AX_MASK                                    (0xFFU << SFC_AX0_AX_SHIFT)                                  /* 0x000000FF */
/* ABIT0 */
#define SFC_ABIT0_ABIT_SHIFT                               (0U)
#define SFC_ABIT0_ABIT_MASK                                (0x1FU << SFC_ABIT0_ABIT_SHIFT)                              /* 0x0000001F */
/* ISR */
...
#define SFC_QOP_SO123BP_SHIFT                              (1U)
#define SFC_QOP_SO123BP_MASK                               (0x1U << SFC_QOP_SO123BP_SHIFT)                              /* 0x00000002 */
/* EXT_CTRL */
#define SFC_EXT_CTRL_CS_DESEL_CTRL_SHIFT                   (0U)
#define SFC_EXT_CTRL_CS_DESEL_CTRL_MASK                    (0xFU << SFC_EXT_CTRL_CS_DESEL_CTRL_SHIFT)                   /* 0x0000000F */
...
#define SFC_EXT_CTRL_TRANS_INT_MODE_SHIFT                  (13U)
#define SFC_EXT_CTRL_TRANS_INT_MODE_MASK                   (0x1U << SFC_EXT_CTRL_TRANS_INT_MODE_SHIFT)                  /* 0x00002000 */
#define SFC_EXT_CTRL_SR_GEN_MODE_SHIFT                     (14U)
#define SFC_EXT_CTRL_SR_GEN_MODE_MASK                      (0x1U << SFC_EXT_CTRL_SR_GEN_MODE_SHIFT)                     /* 0x00004000 */
/* POLL_CTRL */
...
#define SFC_POLL_CTRL_POLL_DLY_EN_SHIFT                    (1U)
#define SFC_POLL_CTRL_POLL_DLY_EN_MASK                     (0x1U << SFC_POLL_CTRL_POLL_DLY_EN_SHIFT)                    /* 0x00000002 */
...
/* DLL_CTRL0 */
#define SFC_DLL_CTRL0_SMP_DLL_CFG_SHIFT                    (0U)
#define SFC_DLL_CTRL0_SMP_DLL_CFG_MASK                     (0xFFU << SFC_DLL_CTRL0_SMP_DLL_CFG_SHIFT)                   /* 0x000000FF */
#define SFC_DLL_CTRL0_SCLK_SMP_SEL_SHIFT                   (8U)
#define SFC_DLL_CTRL0_SCLK_SMP_SEL_MASK                    (0x1U << SFC_DLL_CTRL0_SCLK_SMP_SEL_SHIFT)                   /* 0x00000100 */
/* HRDYMASK */
#define SFC_HRDYMASK_HRDYMASK_SHIFT                        (0U)
#define SFC_HRDYMASK_HRDYMASK_MASK                         (0x1U << SFC_HRDYMASK_HRDYMASK_SHIFT)                        /* 0x00000001 */
/* EXT_AX */
#define SFC_EXT_AX_AX_CANCEL_PAT_SHIFT                     (0U)
#define SFC_EXT_AX_AX_CANCEL_PAT_MASK                      (0xFFU << SFC_EXT_AX_AX_CANCEL_PAT_SHIFT)                    /* 0x000000FF */
#define SFC_EXT_AX_AX_SETUP_PAT_SHIFT                      (8U)
#define SFC_EXT_AX_AX_SETUP_PAT_MASK                       (0xFFU << SFC_EXT_AX_AX_SETUP_PAT_SHIFT)                     /* 0x0000FF00 */
/* SCLK_INATM_CNT */
#define SFC_SCLK_INATM_CNT_SCLK_INATM_CNT_SHIFT            (0U)
#define SFC_SCLK_INATM_CNT_SCLK_INATM_CNT_MASK             (0xFFFFFFFFU << SFC_SCLK_INATM_CNT_SCLK_INATM_CNT_SHIFT)     /* 0xFFFFFFFF */
/* AUTO_RF_CNT */
#define SFC_AUTO_RF_CNT_AUTO_RF_CNT_SHIFT                  (0U)
#define SFC_AUTO_RF_CNT_AUTO_RF_CNT_MASK                   (0xFFFFFFFFU << SFC_AUTO_RF_CNT_AUTO_RF_CNT_SHIFT)           /* 0xFFFFFFFF */
/* XMMC_WCMD0 */
#define SFC_XMMC_WCMD0_CMD_SHIFT                           (0U)
#define SFC_XMMC_WCMD0_CMD_MASK                            (0xFFU << SFC_XMMC_WCMD0_CMD_SHIFT)                          /* 0x000000FF */
#define SFC_XMMC_WCMD0_DUMM_SHIFT                          (8U)
#define SFC_XMMC_WCMD0_DUMM_MASK                           (0xFU << SFC_XMMC_WCMD0_DUMM_SHIFT)                          /* 0x00000F00 */
#define SFC_XMMC_WCMD0_CONT_SHIFT                          (13U)
#define SFC_XMMC_WCMD0_CONT_MASK                           (0x1U << SFC_XMMC_WCMD0_CONT_SHIFT)                          /* 0x00002000 */
#define SFC_XMMC_WCMD0_ADDRB_SHIFT                         (14U)
#define SFC_XMMC_WCMD0_ADDRB_MASK                          (0x3U << SFC_XMMC_WCMD0_ADDRB_SHIFT)                         /* 0x0000C000 */
/* XMMC_RCMD0 */
#define SFC_XMMC_RCMD0_CMD_SHIFT                           (0U)
#define SFC_XMMC_RCMD0_CMD_MASK                            (0xFFU << SFC_XMMC_RCMD0_CMD_SHIFT)                          /* 0x000000FF */
#define SFC_XMMC_RCMD0_DUMM_SHIFT                          (8U)
#define SFC_XMMC_RCMD0_DUMM_MASK                           (0xFU << SFC_XMMC_RCMD0_DUMM_SHIFT)                          /* 0x00000F00 */
#define SFC_XMMC_RCMD0_CONT_SHIFT                          (13U)
#define SFC_XMMC_RCMD0_CONT_MASK                           (0x1U << SFC_XMMC_RCMD0_CONT_SHIFT)                          /* 0x00002000 */
#define SFC_XMMC_RCMD0_ADDRB_SHIFT                         (14U)
#define SFC_XMMC_RCMD0_ADDRB_MASK                          (0x3U << SFC_XMMC_RCMD0_ADDRB_SHIFT)                         /* 0x0000C000 */
/* XMMC_CTRL */
#define SFC_XMMC_CTRL_DEV_HWEN_SHIFT                       (5U)
#define SFC_XMMC_CTRL_DEV_HWEN_MASK                        (0x1U << SFC_XMMC_CTRL_DEV_HWEN_SHIFT)                       /* 0x00000020 */
#define SFC_XMMC_CTRL_PFT_EN_SHIFT                         (6U)
#define SFC_XMMC_CTRL_PFT_EN_MASK                          (0x1U << SFC_XMMC_CTRL_PFT_EN_SHIFT)                         /* 0x00000040 */
#define SFC_XMMC_CTRL_UINCR_PFT_EN_SHIFT                   (7U)
#define SFC_XMMC_CTRL_UINCR_PFT_EN_MASK                    (0x1U << SFC_XMMC_CTRL_UINCR_PFT_EN_SHIFT)                   /* 0x00000080 */
#define SFC_XMMC_CTRL_UINCR_LEN_SHIFT                      (8U)
#define SFC_XMMC_CTRL_UINCR_LEN_MASK                       (0xFU << SFC_XMMC_CTRL_UINCR_LEN_SHIFT)                      /* 0x00000F00 */
#define SFC_XMMC_CTRL_DEV_WRAP_EN_SHIFT                    (12U)
#define SFC_XMMC_CTRL_DEV_WRAP_EN_MASK                     (0x1U << SFC_XMMC_CTRL_DEV_WRAP_EN_SHIFT)                    /* 0x00001000 */
#define SFC_XMMC_CTRL_DEV_INCR_EN_SHIFT                    (13U)
#define SFC_XMMC_CTRL_DEV_INCR_EN_MASK                     (0x1U << SFC_XMMC_CTRL_DEV_INCR_EN_SHIFT)                    /* 0x00002000 */
#define SFC_XMMC_CTRL_DEV_UDFINCR_EN_SHIFT                 (14U)
#define SFC_XMMC_CTRL_DEV_UDFINCR_EN_MASK                  (0x1U << SFC_XMMC_CTRL_DEV_UDFINCR_EN_SHIFT)                 /* 0x00004000 */
/* MODE */
#define SFC_MODE_XMMC_MODE_EN_SHIFT                        (0U)
#define SFC_MODE_XMMC_MODE_EN_MASK                         (0x1U << SFC_MODE_XMMC_MODE_EN_SHIFT)                        /* 0x00000001 */
/* DEVRGN */
#define SFC_DEVRGN_RSIZE_SHIFT                             (0U)
#define SFC_DEVRGN_RSIZE_MASK                              (0x1FU << SFC_DEVRGN_RSIZE_SHIFT)                            /* 0x0000001F */
/* DEVSIZE0 */
#define SFC_DEVSIZE0_DSIZE_SHIFT                           (0U)
#define SFC_DEVSIZE0_DSIZE_MASK                            (0x1FU << SFC_DEVSIZE0_DSIZE_SHIFT)                          /* 0x0000001F */
/* TME0 */
#define SFC_TME0_AUTO_RF_EN_SHIFT                          (0U)
#define SFC_TME0_AUTO_RF_EN_MASK                           (0x1U << SFC_TME0_AUTO_RF_EN_SHIFT)                          /* 0x00000001 */
#define SFC_TME0_SCLK_INATM_EN_SHIFT                       (1U)
#define SFC_TME0_SCLK_INATM_EN_MASK                        (0x1U << SFC_TME0_SCLK_INATM_EN_SHIFT)                       /* 0x00000002 */
/* POLLDLY_CTRL */
#define SFC_POLLDLY_CTRL_CNT_SHIFT                         (0U)
#define SFC_POLLDLY_CTRL_CNT_MASK                          (0x7FFFFFFFU << SFC_POLLDLY_CTRL_CNT_SHIFT)                  /* 0x7FFFFFFF */
#define SFC_POLLDLY_CTRL_POLLDLY_IP_SHIFT                  (31U)
#define SFC_POLLDLY_CTRL_POLLDLY_IP_MASK                   (0x1U << SFC_POLLDLY_CTRL_POLLDLY_IP_SHIFT)                  /* 0x80000000 */
/* DMATR */
...
#define SFC_POLL_DATA_POLL_STA_SHIFT                       (8U)
#define SFC_POLL_DATA_POLL_STA_MASK                        (0x1U << SFC_POLL_DATA_POLL_STA_SHIFT)                       /* 0x00000100 */
/* XMMCSR */
#define SFC_XMMCSR_SLOPOVER0_SHIFT                         (0U)
#define SFC_XMMCSR_SLOPOVER0_MASK                          (0x1U << SFC_XMMCSR_SLOPOVER0_SHIFT)                         /* 0x00000001 */
#define SFC_XMMCSR_SLOPOVER1_SHIFT                         (1U)
#define SFC_XMMCSR_SLOPOVER1_MASK                          (0x1U << SFC_XMMCSR_SLOPOVER1_SHIFT)                         /* 0x00000002 */
/* CMD */
...
/* CTRL1 */
#define SFC_CTRL1_SPIM_SHIFT                               (0U)
#define SFC_CTRL1_SPIM_MASK                                (0x1U << SFC_CTRL1_SPIM_SHIFT)                               /* 0x00000001 */
#define SFC_CTRL1_SHIFTPHASE_SHIFT                         (1U)
#define SFC_CTRL1_SHIFTPHASE_MASK                          (0x1U << SFC_CTRL1_SHIFTPHASE_SHIFT)                         /* 0x00000002 */
#define SFC_CTRL1_IDLE_CYCLE_SHIFT                         (4U)
#define SFC_CTRL1_IDLE_CYCLE_MASK                          (0xFU << SFC_CTRL1_IDLE_CYCLE_SHIFT)                         /* 0x000000F0 */
#define SFC_CTRL1_CMDB_SHIFT                               (8U)
#define SFC_CTRL1_CMDB_MASK                                (0x3U << SFC_CTRL1_CMDB_SHIFT)                               /* 0x00000300 */
#define SFC_CTRL1_ADRB_SHIFT                               (10U)
#define SFC_CTRL1_ADRB_MASK                                (0x3U << SFC_CTRL1_ADRB_SHIFT)                               /* 0x00000C00 */
#define SFC_CTRL1_DATB_SHIFT                               (12U)
#define SFC_CTRL1_DATB_MASK                                (0x3U << SFC_CTRL1_DATB_SHIFT)                               /* 0x00003000 */
/* AX1 */
#define SFC_AX1_AX_SHIFT                                   (0U)
#define SFC_AX1_AX_MASK                                    (0xFFU << SFC_AX1_AX_SHIFT)                                  /* 0x000000FF */
/* ABIT1 */
#define SFC_ABIT1_ABIT_SHIFT                               (0U)
#define SFC_ABIT1_ABIT_MASK                                (0x1FU << SFC_ABIT1_ABIT_SHIFT)                              /* 0x0000001F */
/* DLL_CTRL1 */
#define SFC_DLL_CTRL1_SMP_DLL_CFG_SHIFT                    (0U)
#define SFC_DLL_CTRL1_SMP_DLL_CFG_MASK                     (0xFFU << SFC_DLL_CTRL1_SMP_DLL_CFG_SHIFT)                   /* 0x000000FF */
#define SFC_DLL_CTRL1_SCLK_SMP_SEL_SHIFT                   (8U)
#define SFC_DLL_CTRL1_SCLK_SMP_SEL_MASK                    (0x1U << SFC_DLL_CTRL1_SCLK_SMP_SEL_SHIFT)                   /* 0x00000100 */
/* XMMC_WCMD1 */
#define SFC_XMMC_WCMD1_CMD_SHIFT                           (0U)
#define SFC_XMMC_WCMD1_CMD_MASK                            (0xFFU << SFC_XMMC_WCMD1_CMD_SHIFT)                          /* 0x000000FF */
#define SFC_XMMC_WCMD1_DUMM_SHIFT                          (8U)
#define SFC_XMMC_WCMD1_DUMM_MASK                           (0xFU << SFC_XMMC_WCMD1_DUMM_SHIFT)                          /* 0x00000F00 */
#define SFC_XMMC_WCMD1_CONT_SHIFT                          (13U)
#define SFC_XMMC_WCMD1_CONT_MASK                           (0x1U << SFC_XMMC_WCMD1_CONT_SHIFT)                          /* 0x00002000 */
#define SFC_XMMC_WCMD1_ADDRB_SHIFT                         (14U)
#define SFC_XMMC_WCMD1_ADDRB_MASK                          (0x3U << SFC_XMMC_WCMD1_ADDRB_SHIFT)                         /* 0x0000C000 */
/* XMMC_RCMD1 */
#define SFC_XMMC_RCMD1_CMD_SHIFT                           (0U)
#define SFC_XMMC_RCMD1_CMD_MASK                            (0xFFU << SFC_XMMC_RCMD1_CMD_SHIFT)                          /* 0x000000FF */
#define SFC_XMMC_RCMD1_DUMM_SHIFT                          (8U)
#define SFC_XMMC_RCMD1_DUMM_MASK                           (0xFU << SFC_XMMC_RCMD1_DUMM_SHIFT)                          /* 0x00000F00 */
#define SFC_XMMC_RCMD1_CONT_SHIFT                          (13U)
#define SFC_XMMC_RCMD1_CONT_MASK                           (0x1U << SFC_XMMC_RCMD1_CONT_SHIFT)                          /* 0x00002000 */
#define SFC_XMMC_RCMD1_ADDRB_SHIFT                         (14U)
#define SFC_XMMC_RCMD1_ADDRB_MASK                          (0x3U << SFC_XMMC_RCMD1_ADDRB_SHIFT)                         /* 0x0000C000 */
/* DEVSIZE1 */
#define SFC_DEVSIZE1_DSIZE_SHIFT                           (0U)
#define SFC_DEVSIZE1_DSIZE_MASK                            (0x1FU << SFC_DEVSIZE1_DSIZE_SHIFT)                          /* 0x0000001F */
/* TME1 */
#define SFC_TME1_AUTO_RF_EN_SHIFT                          (0U)
