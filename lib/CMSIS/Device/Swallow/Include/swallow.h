...
#define BUFFER_MANAGE_WCH_MBLK_STATUS2_FRAM_CUR_COUNTER_SHIFT (4U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS2_FRAM_CUR_COUNTER_MASK (0x1FFFFU << BUFFER_MANAGE_WCH_MBLK_STATUS2_FRAM_CUR_COUNTER_SHIFT) /* 0x001FFFF0 */
/* WCH_MBLK_STATUS3 */
#define BUFFER_MANAGE_WCH_MBLK_STATUS3_OFFSET            (0x2CU)
#define BUFFER_MANAGE_WCH_MBLK_STATUS3_FRAM_END_COUNTER_SHIFT (4U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS3_FRAM_END_COUNTER_MASK (0x1FFFFU << BUFFER_MANAGE_WCH_MBLK_STATUS3_FRAM_END_COUNTER_SHIFT) /* 0x001FFFF0 */
/* WCH_MBLK_INT_EN */
