...
typedef enum CLOCK_Name {
    ...
    CLK_I2S0_8CH_TX      = CLK(MCLK_I2S0_8CH_TX_SRC_PERI_SEL, 0U),
    ...
    CLK_I2S0_8CH_RX      = CLK(MCLK_I2S0_8CH_RX_SRC_PERI_SEL, 0U),
    DCLK_VOP             = CLK(DCLK_VOP_SRC_SEL, DCLK_VOP_SRC_DIV),
    PCLK_TOP_ROOT        = CLK(PCLK_TOP_ROOT_SEL, 0U),
    CLK_REF_MIPI0_SRC    = CLK(CLK_REF_MIPI0_SRC_SEL, CLK_REF_MIPI0_SRC_DIV),
    CLK_REF_MIPI0_FRAC   = CLK(0U, CLK_REF_MIPI0_FRAC_DIV),
    CLK_REF_MIPI0        = CLK(CLK_REF_MIPI0_OUT_SEL, 0U),
    CLK_REF_MIPI1_SRC    = CLK(CLK_REF_MIPI1_SRC_SEL, CLK_REF_MIPI1_SRC_DIV),
    CLK_REF_MIPI1_FRAC   = CLK(0U, CLK_REF_MIPI1_FRAC_DIV),
    CLK_REF_MIPI1        = CLK(CLK_REF_MIPI1_OUT_SEL, 0U),
    CLK_VICAP_M0_SRC     = CLK(CLK_VICAP_M0_SRC_SEL, CLK_VICAP_M0_SRC_DIV),
    CLK_VICAP_M0_FRAC    = CLK(0U, CLK_VICAP_M0_FRAC_DIV),
    CLK_VICAP_M0         = CLK(CLK_VICAP_M0_OUT_SEL, 0U),
    CLK_VICAP_M1_SRC     = CLK(CLK_VICAP_M1_SRC_SEL, CLK_VICAP_M1_SRC_DIV),
    CLK_VICAP_M1_FRAC    = CLK(0U, CLK_VICAP_M1_FRAC_DIV),
    CLK_VICAP_M1         = CLK(CLK_VICAP_M1_OUT_SEL, 0U),
    HCLK_NPU_ROOT        = CLK((HCLK_NPU_ROOT_SEL | NPUCRU_SEL_BANK), 0U),
    ACLK_NPU_ROOT        = CLK((ACLK_NPU_ROOT_SEL | NPUCRU_SEL_BANK), 0U),
    PCLK_NPU_ROOT        = CLK((PCLK_NPU_ROOT_SEL | NPUCRU_SEL_BANK), 0U),
    HCLK_PERI_ROOT       = CLK((HCLK_PERI_ROOT_SEL | PERICRU_SEL_BANK), 0U),
    ACLK_PERI_ROOT       = CLK((ACLK_PERI_ROOT_SEL | PERICRU_SEL_BANK), 0U),
    PCLK_PERI_ROOT       = CLK((PCLK_PERI_ROOT_SEL | PERICRU_SEL_BANK), 0U),
    CLK_I2C0             = CLK((CLK_I2C0_SEL | PERICRU_SEL_BANK), 0U),
    CLK_I2C2             = CLK((CLK_I2C2_SEL | PERICRU_SEL_BANK), 0U),
    CLK_I2C3             = CLK((CLK_I2C3_SEL | PERICRU_SEL_BANK), 0U),
    CLK_I2C4             = CLK((CLK_I2C4_SEL | PERICRU_SEL_BANK), 0U),
    CLK_SPI1             = CLK((CLK_SPI1_SEL | PERICRU_SEL_BANK), 0U),
    CLK_PWM0             = CLK((CLK_PWM0_PERI_SEL | PERICRU_SEL_BANK), 0U),
    CLK_PWM1             = CLK((CLK_PWM1_PERI_SEL | PERICRU_SEL_BANK), 0U),
    CLK_PWM2             = CLK((CLK_PWM2_PERI_SEL | PERICRU_SEL_BANK), 0U),
    CLK_EMMC             = CLK((CCLK_SRC_EMMC_SEL | PERICRU_SEL_BANK), 0U),
    CLK_SFC              = CLK((SCLK_SFC_SEL | PERICRU_SEL_BANK), 0U),
    ACLK_BUS_ROOT        = CLK((ACLK_BUS_ROOT_SEL | PERICRU_SEL_BANK), 0U),
    CLK_I2C1             = CLK((CLK_I2C1_SEL | PMUCRU_SEL_BANK), 0U),
    HCLK_VEPU_ROOT       = CLK((HCLK_VEPU_ROOT_SEL | VEPUCRU_SEL_BANK), 0U),
    ACLK_VEPU_ROOT       = CLK((ACLK_VEPU_ROOT_SEL | VEPUCRU_SEL_BANK), 0U),
    PCLK_VEPU_ROOT       = CLK((PCLK_VEPU_ROOT_SEL | VEPUCRU_SEL_BANK), 0U),
    ACLK_VEPU_COM_ROOT   = CLK((ACLK_VEPU_COM_ROOT_SEL | VEPUCRU_SEL_BANK), 0U),
    CLK_CORE_VEPU        = CLK((CLK_CORE_VEPU_SEL | VEPUCRU_SEL_BANK), 0U),
    CLK_SPI0             = CLK((CLK_SPI0_SEL | VEPUCRU_SEL_BANK), 0U),
    HCLK_VI_ROOT         = CLK((HCLK_VI_ROOT_SEL | VICRU_SEL_BANK), 0U),
    ACLK_VI_ROOT         = CLK((ACLK_VI_ROOT_SEL | VICRU_SEL_BANK), 0U),
    PCLK_VI_ROOT         = CLK((PCLK_VI_ROOT_SEL | VICRU_SEL_BANK), 0U),
    DCLK_VICAP           = CLK((DCLK_VICAP_SEL | VICRU_SEL_BANK), 0U),
    CLK_SDMMC            = CLK((CCLK_SRC_SDMMC_SEL | VICRU_SEL_BANK), 0U),
    HCLK_VO_ROOT         = CLK((HCLK_VO_ROOT_SEL | VOCRU_SEL_BANK), 0U),
    ACLK_VO_ROOT         = CLK((ACLK_VO_ROOT_SEL | VOCRU_SEL_BANK), 0U),
    PCLK_VO_ROOT         = CLK((PCLK_VO_ROOT_SEL | VOCRU_SEL_BANK), 0U),
    CLK_CORE_RGA2E       = CLK((CLK_CORE_RGA2E_SEL | VOCRU_SEL_BANK), 0U),
    ACLK_VOP_ROOT        = CLK((ACLK_VOP_ROOT_SEL | VOCRU_SEL_BANK), 0U),
    ACLK_MAC_ROOT        = CLK((ACLK_MAC_ROOT_SEL | VOCRU_SEL_BANK), 0U),
    CLK_SDIO             = CLK((CCLK_SRC_SDIO_SEL | VOCRU_SEL_BANK), 0U),
} eCLOCK_Name;
