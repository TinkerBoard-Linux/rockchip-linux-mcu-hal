...
/* OFFSET0 */
#define PWM_OFFSET0_OFFSET                                 (0xE0U)
#define PWM_OFFSET0_CHANNEL_OUTPUT_OFFSET_SHIFT            (0U)
#define PWM_OFFSET0_CHANNEL_OUTPUT_OFFSET_MASK             (0xFFFFFFFFU << PWM_OFFSET0_CHANNEL_OUTPUT_OFFSET_SHIFT)     /* 0xFFFFFFFF */
/* OFFSET1 */
#define PWM_OFFSET1_OFFSET                                 (0xE4U)
#define PWM_OFFSET1_CHANNEL_OUTPUT_OFFSET_SHIFT            (0U)
#define PWM_OFFSET1_CHANNEL_OUTPUT_OFFSET_MASK             (0xFFFFFFFFU << PWM_OFFSET1_CHANNEL_OUTPUT_OFFSET_SHIFT)     /* 0xFFFFFFFF */
/* OFFSET2 */
#define PWM_OFFSET2_OFFSET                                 (0xE8U)
#define PWM_OFFSET2_CHANNEL_OUTPUT_OFFSET_SHIFT            (0U)
#define PWM_OFFSET2_CHANNEL_OUTPUT_OFFSET_MASK             (0xFFFFFFFFU << PWM_OFFSET2_CHANNEL_OUTPUT_OFFSET_SHIFT)     /* 0xFFFFFFFF */
/* OFFSET3 */
#define PWM_OFFSET3_OFFSET                                 (0xECU)
#define PWM_OFFSET3_CHANNEL_OUTPUT_OFFSET_SHIFT            (0U)
#define PWM_OFFSET3_CHANNEL_OUTPUT_OFFSET_MASK             (0xFFFFFFFFU << PWM_OFFSET3_CHANNEL_OUTPUT_OFFSET_SHIFT)     /* 0xFFFFFFFF */
/* IR_TRANS_CTRL */
